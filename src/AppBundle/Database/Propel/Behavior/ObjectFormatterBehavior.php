...
namespace AppBundle\Database\Propel\Behavior;

use Propel\Generator\Model\Behavior;

class ObjectFormatterBehavior extends Behavior
{
    public const DEFAULT_FORMATTER_NAMESPACE = '\\AppBundle\\Database\\Propel\\Formatter\\ObjectFormatter';
    public const CUSTOM_OBJECT_COLLECTION_NAMESPACE = '\\AppBundle\\Database\\Propel\\Collection\\ObjectCollection';
