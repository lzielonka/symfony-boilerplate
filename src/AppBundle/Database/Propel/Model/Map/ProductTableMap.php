...
class ProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.Database.Propel.Model.Map.ProductTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\Database\\Propel\\Model\\Product';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.AppBundle.Database.Propel.Model.Product';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('ProductId', 'Name', 'Description', 'Price', ),
        self::TYPE_CAMELNAME     => array('productId', 'name', 'description', 'price', ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_PRODUCT_ID, ProductTableMap::COL_NAME, ProductTableMap::COL_DESCRIPTION, ProductTableMap::COL_PRICE, ),
        self::TYPE_FIELDNAME     => array('product_id', 'name', 'description', 'price', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('ProductId' => 0, 'Name' => 1, 'Description' => 2, 'Price' => 3, ),
        self::TYPE_CAMELNAME     => array('productId' => 0, 'name' => 1, 'description' => 2, 'price' => 3, ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_PRODUCT_ID => 0, ProductTableMap::COL_NAME => 1, ProductTableMap::COL_DESCRIPTION => 2, ProductTableMap::COL_PRICE => 3, ),
        self::TYPE_FIELDNAME     => array('product_id' => 0, 'name' => 1, 'description' => 2, 'price' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\Database\\Propel\\Model\\Product');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\Database\Propel\Model\Product) { // it's a model object
