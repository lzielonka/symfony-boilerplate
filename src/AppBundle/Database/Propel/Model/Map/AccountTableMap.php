...
class AccountTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.Database.Propel.Model.Map.AccountTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\Database\\Propel\\Model\\Account';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.AppBundle.Database.Propel.Model.Account';
     ...
     */
    const COL_PASSWD = 'account.passwd';

    /**
     * the column name for the salt field
     */
    const COL_SALT = 'account.salt';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('AccountId', 'Email', 'Passwd', 'Salt', ),
        self::TYPE_CAMELNAME     => array('accountId', 'email', 'passwd', 'salt', ),
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ACCOUNT_ID, AccountTableMap::COL_EMAIL, AccountTableMap::COL_PASSWD, AccountTableMap::COL_SALT, ),
        self::TYPE_FIELDNAME     => array('account_id', 'email', 'passwd', 'salt', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('AccountId' => 0, 'Email' => 1, 'Passwd' => 2, 'Salt' => 3, ),
        self::TYPE_CAMELNAME     => array('accountId' => 0, 'email' => 1, 'passwd' => 2, 'salt' => 3, ),
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ACCOUNT_ID => 0, AccountTableMap::COL_EMAIL => 1, AccountTableMap::COL_PASSWD => 2, AccountTableMap::COL_SALT => 3, ),
        self::TYPE_FIELDNAME     => array('account_id' => 0, 'email' => 1, 'passwd' => 2, 'salt' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\Database\\Propel\\Model\\Account');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AccountTableMap::COL_PASSWD);
            $criteria->addSelectColumn(AccountTableMap::COL_SALT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\Database\Propel\Model\Account) { // it's a model object
