...
use \Exception;
use \PDO;
use AppBundle\Database\Propel\Model\Product as ChildProduct;
use AppBundle\Database\Propel\Model\ProductQuery as ChildProductQuery;
use AppBundle\Database\Propel\Model\Map\ProductTableMap;
 ...
 *
 * @method     ChildProduct[]|\AppBundle\Database\Propel\Collection\ObjectCollection find(ConnectionInterface $con = null) Return ChildProduct objects based on current ModelCriteria
 * @method     ChildProduct[]|\AppBundle\Database\Propel\Collection\ObjectCollection findByProductId(int $product_id) Return ChildProduct objects filtered by the product_id column
 * @method     ChildProduct[]|\AppBundle\Database\Propel\Collection\ObjectCollection findByName(string $name) Return ChildProduct objects filtered by the name column
 * @method     ChildProduct[]|\AppBundle\Database\Propel\Collection\ObjectCollection findByDescription(string $description) Return ChildProduct objects filtered by the description column
 * @method     ChildProduct[]|\AppBundle\Database\Propel\Collection\ObjectCollection findByPrice(string $price) Return ChildProduct objects filtered by the price column
...
abstract class ProductQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \AppBundle\Database\Propel\Model\Base\ProductQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\AppBundle\\Database\\Propel\\Model\\Product', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT product_id, name, description, price FROM product WHERE product_id = :p0';
        try {
