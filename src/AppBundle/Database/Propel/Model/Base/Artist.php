...
abstract class Artist implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Database\\Propel\\Model\\Map\\ArtistTableMap';
    ...
    /**
     * @var        \AppBundle\Database\Propel\Collection\ObjectCollection|ChildAlbum[] Collection to store aggregation of ChildAlbum objects.
     */
     ...
     * @var \AppBundle\Database\Propel\Collection\ObjectCollection|ChildAlbum[]
     */
    protected $albumsScheduledForDeletion = null;

    /**
     * Initializes internal state of AppBundle\Database\Propel\Model\Base\Artist object.
     */
     ...
     * @return $this|\AppBundle\Database\Propel\Model\Artist The current object (for fluent API support)
     */
    public function setArtistId($v)
    {
        ...
        if ($this->artist_id !== $v) {
            $this->artist_id = $v;
            $this->modifiedColumns[ArtistTableMap::COL_ARTIST_ID] = true;
        }
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[ArtistTableMap::COL_FIRSTNAME] = true;
        }
    ...
    public function setLastname($v)
    {
        ...
        if ($this->lastname !== $v) {
            $this->lastname = $v;
            $this->modifiedColumns[ArtistTableMap::COL_LASTNAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ArtistTableMap::translateFieldName('ArtistId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->artist_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArtistTableMap::translateFieldName('Firstname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->firstname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArtistTableMap::translateFieldName('Lastname', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\Database\\Propel\\Model\\Artist'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->albumsScheduledForDeletion !== null) {
                if (!$this->albumsScheduledForDeletion->isEmpty()) {
                    \AppBundle\Database\Propel\Model\AlbumQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArtistTableMap::COL_ARTIST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'artist_id';
        }
        if ($this->isColumnModified(ArtistTableMap::COL_FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'firstname';
        }
        if ($this->isColumnModified(ArtistTableMap::COL_LASTNAME)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Database\Propel\Model\Artist
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Database\Propel\Model\Artist The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArtistTableMap::COL_ARTIST_ID)) {
            $criteria->add(ArtistTableMap::COL_ARTIST_ID, $this->artist_id);
        }
        if ($this->isColumnModified(ArtistTableMap::COL_FIRSTNAME)) {
            $criteria->add(ArtistTableMap::COL_FIRSTNAME, $this->firstname);
        }
        if ($this->isColumnModified(ArtistTableMap::COL_LASTNAME)) {
            $criteria->add(ArtistTableMap::COL_LASTNAME, $this->lastname);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Database\Propel\Model\Artist (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Database\Propel\Model\Artist Clone of current object.
     * @throws PropelException
     */
    ...
    public function initAlbums($overrideExisting = true)
    {
        ...
        $this->collAlbums->setModel('\AppBundle\Database\Propel\Model\Album');
    }
     ...
     * @return \AppBundle\Database\Propel\Collection\ObjectCollection|ChildAlbum[] List of ChildAlbum objects
     * @throws PropelException
     */
