...
abstract class Movie implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Database\\Propel\\Model\\Map\\MovieTableMap';
    ...
    /**
     * Initializes internal state of AppBundle\Database\Propel\Model\Base\Movie object.
     */
     ...
     * @return $this|\AppBundle\Database\Propel\Model\Movie The current object (for fluent API support)
     */
    public function setMovieId($v)
    {
        ...
        if ($this->movie_id !== $v) {
            $this->movie_id = $v;
            $this->modifiedColumns[MovieTableMap::COL_MOVIE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MovieTableMap::translateFieldName('MovieId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\Database\\Propel\\Model\\Movie'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MovieTableMap::COL_MOVIE_ID)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Database\Propel\Model\Movie
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Database\Propel\Model\Movie The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MovieTableMap::COL_MOVIE_ID)) {
            $criteria->add(MovieTableMap::COL_MOVIE_ID, $this->movie_id);
        }
        if ($this->isColumnModified(MovieTableMap::COL_TITLE)) {
    ...
    /**
     * Generic method to set the primary key (movie_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Database\Propel\Model\Movie (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setMovieId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Database\Propel\Model\Movie Clone of current object.
     * @throws PropelException
     */
    ...
    public function setAccountMovies(Collection $accountMovies, ConnectionInterface $con = null)
    {
        ...
        foreach ($accountMoviesToDelete as $accountMovieRemoved) {
            $accountMovieRemoved->setMovie(null);
        }
     ...
     * @return \AppBundle\Database\Propel\Collection\ObjectCollection|ChildAccountMovie[] List of ChildAccountMovie objects
     */
    public function getAccountMoviesJoinAccount(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAccountMovieQuery::create(null, $criteria);
