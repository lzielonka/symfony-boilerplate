...
/**
 * Base class that represents a row from the 'account_song' table.
 *
 *
 *
 * @package    propel.generator.src.AppBundle.Database.Propel.Model.Base
 */
abstract class AccountSong implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Database\\Propel\\Model\\Map\\AccountSongTableMap';
    ...
    /**
     * Initializes internal state of AppBundle\Database\Propel\Model\Base\AccountSong object.
     */
    ...
    /**
     * Compares this with another <code>AccountSong</code> instance.  If
     * <code>obj</code> is an instance of <code>AccountSong</code>, delegates to
     * <code>equals(AccountSong)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AccountSong The current object, for fluid interface
     */
     ...
     * @return $this|\AppBundle\Database\Propel\Model\AccountSong The current object (for fluent API support)
     */
    public function setAccountId($v)
    {
        ...
        if ($this->account_id !== $v) {
            $this->account_id = $v;
            $this->modifiedColumns[AccountSongTableMap::COL_ACCOUNT_ID] = true;
        }
    ...
    public function setSongId($v)
    {
        ...
        if ($this->song_id !== $v) {
            $this->song_id = $v;
            $this->modifiedColumns[AccountSongTableMap::COL_SONG_ID] = true;
        }

        if ($this->aSong !== null && $this->aSong->getSongId() !== $v) {
            $this->aSong = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AccountSongTableMap::translateFieldName('AccountId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->account_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AccountSongTableMap::translateFieldName('SongId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = AccountSongTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\Database\\Propel\\Model\\AccountSong'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aSong !== null && $this->song_id !== $this->aSong->getSongId()) {
            $this->aSong = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(AccountSongTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildAccountSongQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AccountSong::setDeleted()
     * @see AccountSong::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAccountSongQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AccountSongTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccountSongTableMap::COL_ACCOUNT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'account_id';
        }
        if ($this->isColumnModified(AccountSongTableMap::COL_SONG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'song_id';
        }

        $sql = sprintf(
            'INSERT INTO account_song (%s) VALUES (%s)',
    ...
    {
        $pos = AccountSongTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['AccountSong'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AccountSong'][$this->hashCode()] = true;
        $keys = AccountSongTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Database\Propel\Model\AccountSong
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Database\Propel\Model\AccountSong The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(AccountSongTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AccountSongTableMap::COL_ACCOUNT_ID)) {
            $criteria->add(AccountSongTableMap::COL_ACCOUNT_ID, $this->account_id);
        }
        if ($this->isColumnModified(AccountSongTableMap::COL_SONG_ID)) {
            $criteria->add(AccountSongTableMap::COL_SONG_ID, $this->song_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Database\Propel\Model\AccountSong (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Database\Propel\Model\AccountSong Clone of current object.
     * @throws PropelException
     */
    ...
    public function getAccount(ConnectionInterface $con = null)
    {
        if ($this->aAccount === null && ($this->account_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAccount->addAccountSongs($this);
             */
        }
    ...
    public function getSong(ConnectionInterface $con = null)
    {
        if ($this->aSong === null && ($this->song_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSong->addAccountSongs($this);
             */
        }
    ...
    {
        if (null !== $this->aAccount) {
            $this->aAccount->removeAccountSong($this);
        }
        if (null !== $this->aSong) {
            $this->aSong->removeAccountSong($this);
        }
    ...
    {
        return (string) $this->exportTo(AccountSongTableMap::DEFAULT_STRING_FORMAT);
    }
