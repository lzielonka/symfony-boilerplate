...
abstract class Series implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Database\\Propel\\Model\\Map\\SeriesTableMap';
    ...
    /**
     * Initializes internal state of AppBundle\Database\Propel\Model\Base\Series object.
     */
     ...
     * @return $this|\AppBundle\Database\Propel\Model\Series The current object (for fluent API support)
     */
    public function setSeriesId($v)
    {
        ...
        if ($this->series_id !== $v) {
            $this->series_id = $v;
            $this->modifiedColumns[SeriesTableMap::COL_SERIES_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[SeriesTableMap::COL_TITLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SeriesTableMap::translateFieldName('SeriesId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->series_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SeriesTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = SeriesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\Database\\Propel\\Model\\Series'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SeriesTableMap::COL_SERIES_ID)) {
            $modifiedColumns[':p' . $index++]  = 'series_id';
        }
        if ($this->isColumnModified(SeriesTableMap::COL_TITLE)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Database\Propel\Model\Series
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Database\Propel\Model\Series The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SeriesTableMap::COL_SERIES_ID)) {
            $criteria->add(SeriesTableMap::COL_SERIES_ID, $this->series_id);
        }
        if ($this->isColumnModified(SeriesTableMap::COL_TITLE)) {
            $criteria->add(SeriesTableMap::COL_TITLE, $this->title);
        }
    ...
    /**
     * Generic method to set the primary key (series_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Database\Propel\Model\Series (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Database\Propel\Model\Series Clone of current object.
     * @throws PropelException
     */
    ...
    public function setAccountSeriess(Collection $accountSeriess, ConnectionInterface $con = null)
    {
        ...
        foreach ($accountSeriessToDelete as $accountSeriesRemoved) {
            $accountSeriesRemoved->setSeries(null);
        }
     ...
     * @return \AppBundle\Database\Propel\Collection\ObjectCollection|ChildAccountSeries[] List of ChildAccountSeries objects
     */
    public function getAccountSeriessJoinAccount(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAccountSeriesQuery::create(null, $criteria);
