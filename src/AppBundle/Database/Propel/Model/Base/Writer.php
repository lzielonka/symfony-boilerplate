...
/**
 * Base class that represents a row from the 'writer' table.
 *
 *
 *
 * @package    propel.generator.src.AppBundle.Database.Propel.Model.Base
 */
abstract class Writer implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\AppBundle\\Database\\Propel\\Model\\Map\\WriterTableMap';
    ...
    /**
     * @var        \AppBundle\Database\Propel\Collection\ObjectCollection|ChildBook[] Collection to store aggregation of ChildBook objects.
     */
    protected $collBooks;
     ...
     * @var \AppBundle\Database\Propel\Collection\ObjectCollection|ChildBook[]
     */
    protected $booksScheduledForDeletion = null;

    /**
     * Initializes internal state of AppBundle\Database\Propel\Model\Base\Writer object.
     */
    ...
    /**
     * Compares this with another <code>Writer</code> instance.  If
     * <code>obj</code> is an instance of <code>Writer</code>, delegates to
     * <code>equals(Writer)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Writer The current object, for fluid interface
     */
     ...
     * @return $this|\AppBundle\Database\Propel\Model\Writer The current object (for fluent API support)
     */
    public function setWriterId($v)
    {
        ...
        if ($this->writer_id !== $v) {
            $this->writer_id = $v;
            $this->modifiedColumns[WriterTableMap::COL_WRITER_ID] = true;
        }
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[WriterTableMap::COL_FIRSTNAME] = true;
        }
    ...
    public function setLastname($v)
    {
        ...
        if ($this->lastname !== $v) {
            $this->lastname = $v;
            $this->modifiedColumns[WriterTableMap::COL_LASTNAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WriterTableMap::translateFieldName('WriterId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->writer_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WriterTableMap::translateFieldName('Firstname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->firstname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WriterTableMap::translateFieldName('Lastname', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = WriterTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AppBundle\\Database\\Propel\\Model\\Writer'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWriterQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Writer::setDeleted()
     * @see Writer::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWriterQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WriterTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->booksScheduledForDeletion !== null) {
                if (!$this->booksScheduledForDeletion->isEmpty()) {
                    \AppBundle\Database\Propel\Model\BookQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WriterTableMap::COL_WRITER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'writer_id';
        }
        if ($this->isColumnModified(WriterTableMap::COL_FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'firstname';
        }
        if ($this->isColumnModified(WriterTableMap::COL_LASTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'lastname';
        }

        $sql = sprintf(
            'INSERT INTO writer (%s) VALUES (%s)',
    ...
    {
        $pos = WriterTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Writer'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Writer'][$this->hashCode()] = true;
        $keys = WriterTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getWriterId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AppBundle\Database\Propel\Model\Writer
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AppBundle\Database\Propel\Model\Writer The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WriterTableMap::COL_WRITER_ID)) {
            $criteria->add(WriterTableMap::COL_WRITER_ID, $this->writer_id);
        }
        if ($this->isColumnModified(WriterTableMap::COL_FIRSTNAME)) {
            $criteria->add(WriterTableMap::COL_FIRSTNAME, $this->firstname);
        }
        if ($this->isColumnModified(WriterTableMap::COL_LASTNAME)) {
            $criteria->add(WriterTableMap::COL_LASTNAME, $this->lastname);
        }
    ...
    {
        $criteria = ChildWriterQuery::create();
        $criteria->add(WriterTableMap::COL_WRITER_ID, $this->writer_id);
    ...
    /**
     * Generic method to set the primary key (writer_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AppBundle\Database\Propel\Model\Writer (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setWriterId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AppBundle\Database\Propel\Model\Writer Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\AppBundle\Database\Propel\Model\Book');
    }
     ...
     * If this ChildWriter is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return \AppBundle\Database\Propel\Collection\ObjectCollection|ChildBook[] List of ChildBook objects
     * @throws PropelException
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildWriter The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(WriterTableMap::DEFAULT_STRING_FORMAT);
    }
